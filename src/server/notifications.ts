...
const defaultPreferences:NotificationPreferences={inApp:true,email:true,push:false,smsCriticalOnly:false,digest:'realtime',quietHours:{enabled:true,start:'22:00',end:'07:00'},timezone:'UTC'};
