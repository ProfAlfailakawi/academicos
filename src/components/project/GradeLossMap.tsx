            ...
            <div key={c.rubricId} className="rounded-2xl border hairline bg-[var(--bg)] p-4">
              <div className="flex items-center justify-between gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  {c.personalRisk === 'critical' && <span className="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[9px] font-bold" style={{ background: '#f7dede', color: 'var(--danger)' }}><AlertTriangle size={11} />{t('adv.gl.riskYou')}</span>}
